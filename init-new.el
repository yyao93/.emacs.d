...
;; Init-Newialize package sources
(require 'package)
...
(package-init-newialize)
(unless package-archive-contents
  (package-refresh-contents))

;; Init-Newialize use-package on non-Linux platforms
...
(use-package counsel
  ...
  :config
  (setq ivy-init-newial-inputs-alist nil)) ;; don't start searches with ^
;; (use-package helm
;;   :demand t
;;   :bind ("M-x" . helm-M-x)
;;   :config (helm-mode 1)
...
;; latex
(exec-path-from-shell-init-newialize)
